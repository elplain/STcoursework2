...
public class A5CartTest extends A0WebDriverSetup {

    @ParameterizedTest
    @CsvFileSource(resources = "/A5testdata.csv", numLinesToSkip = 1)
    void testLogin(String username, String password, String shouldSucceed, String fn, String ln, String postccode) {
        ...
        try {
            ...
            if (isSuccess) {
                Assertions.assertTrue(url.contains("/checkout-complete.html"));
